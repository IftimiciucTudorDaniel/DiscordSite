  ...
  "
                    ...
                    <div className={`space-y-6 transition-all duration-1000 md:order-2 ${
                        ...
                        <div className="inline-flex items-center gap-2 bg-stone-950/80 border border-neutral-800 rounded-md px-3 py-2">
                            <span className="text-sm font-medium text-white">Trading-Profit-and-Loss</span>
                        </div>
                        ...
                        <p className="text-base text-stone-300 leading-relaxed max-w-md">
                            Watch our trading community celebrate real wins together. Members share their actual trade results from our various groups, from beginner gains to six-figure profits. This transparent sharing builds accountability, motivation, and proves the effectiveness of our structured trading strategies across all account sizes.                        </p>
                        ...
                        <div className="flex flex-wrap gap-2.5">
                            ...
                            <div className="bg-stone-950 border border-neutral-800 rounded-md px-3 py-2">
                                <span className="text-sm font-medium text-white">Community Wins</span>
                            </div>
                            <div className="bg-stone-950 border border-neutral-800 rounded-md px-3 py-2">
                                <span className="text-sm font-medium text-white">Transparency</span>
                            </div>
                        </div>
                    </div>
...
export default AIAssistantSectionLeft2;